...
const aliceTx = alice.generateTx(bob.wallet.address, 50, 'send')
...
console.log('Is it? ')
console.log(paypal.checkTx(aliceTx))
console.log('Alice has a balance of 0, but the transaction is trying to spend 10. In order to send tokens on the Paypal network Alice is going to have to buy them from Paypal Inc.')
...
const checkAliceAccountBalance = alice.generateTx(bob.wallet.address, 0, 'check')
...
const payBobBackForKetchup = aliceTx
